...
1) If the gray areas overlap each other, you might be using Windows10 Scaling option. Simply download this version: [IdleonHelper_woScaling.exe](https://github.com/se7enek/IdleonHelper/releases/download/v.1.0.0/IdleonHelper_woScaling.exe)
